...
class TrainingModuleController extends Controller
{
    ...
    public $settings = [
        'model' => '\\App\\Models\\TrainingModule',
        'caption' => "Training Module",
        'xFolder' => "Admin/Pages/TrainingModule",
        'indexRoute' => "/admin/training-module",
        'storageName' => "training_modules",
        'isList' => true,
        'isCreate' => true,
        'isView' => true,
        'isEdit' => true,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $trainingModule = $this->defaultModel::updateOrCreate(["uuid" => $this->pKey], $record);
