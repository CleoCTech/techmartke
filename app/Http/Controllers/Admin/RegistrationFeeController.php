...
class RegistrationFeeController extends Controller
{
    ...
    public $settings = [
        'model' => '\\App\\Models\\RegistrationFee',
        'caption' => "Registration Fee",
        'xFolder' => "Admin/Pages/RegistrationFee",
        'indexRoute' => "/admin/registration-fee",
        'storageName' => "registration_fees",
        'isList' => true,
        'isCreate' => true,
        'isView' => true,
        'isEdit' => true,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $registrationFee = $this->defaultModel::updateOrCreate(["uuid" => $this->pKey], $record);
