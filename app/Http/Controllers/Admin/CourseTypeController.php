...
class CourseTypeController extends Controller
{
    ...
    public $settings = [
        'model' => '\\App\\Models\\CourseType',
        'caption' => "Course Type",
        'xFolder' => "Admin/Pages/CourseType",
        'indexRoute' => "/admin/course-type",
        'storageName' => "course_types",
        'isList' => true,
        'isCreate' => true,
        'isView' => true,
        'isEdit' => true,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $courseType = $this->defaultModel::updateOrCreate(["uuid" => $this->pKey], $record);
