            ...
            <x-grid>
                ...
                <x-grid-col>
                    <x-show-group>
                        ...
                        <template #value>{{cardData.other}}</template>
                    </x-show-group>
                </x-grid-col>
                <x-grid-col>
                    <x-show-group>
                        <template #label>Space</template>
                        <template #value>{{cardData.space}}</template>
                    </x-show-group>
                </x-grid-col>
                <x-grid-col>
                    <x-show-group>
                        <template #label>Period</template>
                        <template #value>{{cardData.period}}</template>
                    </x-show-group>
                </x-grid-col>
                <x-grid-col>
                    <x-show-group>
                    ...
                    <template #value>
                        <img :src="$page.props.storagePaths[setup.settings.storageName].images.readPath + cardData.cover_image" class="h-28 w-28" />
                    </template>
                    </x-show-group>
                </x-grid-col>
