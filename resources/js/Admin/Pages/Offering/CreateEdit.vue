            ...
            <form v-on:submit.prevent="submit" action="#" method="POST" enctype="multipart/form-data">
                <x-grid>
                    ...
                    <x-grid-col class="sm:col-span-4">
                        <x-form-group>
                            <template #label>Total Offerings</template>
                            <template #value>
                                <TextInput type="number" v-model="form.total_offerings" />
                            </template>
                        </x-form-group>
                    </x-grid-col>
                    ...
                    <x-grid-col class="sm:col-span-4">
                        <x-form-group>
                            <template #label>Total Tithes</template>
                            <template #value>
                                <TextInput type="number" v-model="form.total_tithes" />
                            </template>
                        </x-form-group>
                    </x-grid-col>
                    ...
                    <x-grid-col class="sm:col-span-4">
                        <x-form-group>
                            <template #label>Cash Offerings</template>
                            <template #value>
                                <TextInput type="number" v-model="form.cash_offerings" />
                            </template>
                        </x-form-group>
                    </x-grid-col>
                    ...
                    <x-grid-col class="sm:col-span-4">
                        <x-form-group>
                            <template #label>Online Offerings</template>
                            <template #value>
                                <TextInput type="number" v-model="form.online_offerings" />
                            </template>
                        </x-form-group>
                    </x-grid-col>
...
const form = reactive({
    uuid: null,
    service_id: null,
    total_offerings: null,
    total_tithes: null,
    cash_offerings: null,
    online_offerings: null,
    remarks: null,
});
...
const setData = () => {
    if (props.cardData != null && props.cardData.uuid != null) {
        ...
        form.total_offerings = props.cardData.total_offerings;
        form.total_tithes = props.cardData.total_tithes;
        form.cash_offerings = props.cardData.cash_offerings;
        form.online_offerings = props.cardData.online_offerings;
