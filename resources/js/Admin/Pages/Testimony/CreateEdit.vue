<template>
    <div>
        ...
        <x-create-edit-template :setup="setup" :selected="selected">
            <form v-on:submit.prevent="validateAndSubmit" action="#" method="POST" enctype="multipart/form-data">
                <x-grid class="gap-4">
                    <!-- Service Selection -->
                    ...
                    <x-grid-col class="col-span-12 sm:col-span-12">
                        <x-form-group class="sm:grid-cols-1">
                            <template #label>Testifier Name</template>
                            <template #value>
                                <TextInput type="text" v-model="form.testifier_name" class="w-full" />
                            </template>
                        </x-form-group>
                    </x-grid-col>
                    ...
                    <x-grid-col class="col-span-12 sm:col-span-12">
                        <x-form-group class="sm:grid-cols-1">
                            <template #label>Testimony</template>
                            <template #value>
                                <ckeditor v-cloak :editor="editor" v-model="form.testimony" @ready="cardData != null? form.testimony = cardData.testimony :''"></ckeditor>
                            </template>
                        </x-form-group>
                    </x-grid-col>
                    ...
                    <x-grid-col class="col-span-12 sm:col-span-12">
                        <x-form-group class="sm:grid-cols-1">
                            ...
                            <template #value>
                                <TextInput type="text" v-model="form.remarks" class="w-full" />
                            </template>
                        </x-form-group>
                    </x-grid-col>
                </x-grid>
...
const setData = () => {
    if (props.cardData != null && props.cardData.uuid != null) {
        ...
        form.testifier_name = props.cardData.testifier_name;
        form.testimony = props.cardData.testimony;
