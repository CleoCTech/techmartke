    ...
    <ul class="flex flex-wrap justify-center sm:justify-start mb-8 sm:mb-0 -space-x-3 -ml-px">
      <li>
        <router-link class="block" to="#0">
          <img class="w-9 h-9 rounded-full" src="/assets/img/placeholder.jpg" width="36" height="36" alt="User 01" />
        </router-link>
      </li>
      <li>
        <router-link class="block" to="#0">
          <img class="w-9 h-9 rounded-full" src="/assets/img/placeholder.jpg" width="36" height="36" alt="User 02" />
        </router-link>
      </li>
      <li>
        <router-link class="block" to="#0">
          <img class="w-9 h-9 rounded-full" src="/assets/img/placeholder.jpg" width="36" height="36" alt="User 03" />
        </router-link>
      </li>
      <li>
        <router-link class="block" to="#0">
          <img class="w-9 h-9 rounded-full" src="/assets/img/placeholder.jpg" width="36" height="36" alt="User 04" />
        </router-link>
      </li>
      <li>
