<template>
  <div class="relative">
    ...
    >
      <img class="w-8 h-8 rounded-full mr-2" src="/assets/img/placeholder.jpg" width="32" height="32" alt="Group 01" />
      <div class="truncate">
        ...
        >
            ...
            <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
              <div class="flex items-center justify-between">
                <div class="grow flex items-center truncate">
                  <img class="w-7 h-7 rounded-full mr-2" src="/assets/img/placeholder.jpg" width="28" height="28" alt="Channel 01" />
          ...
          <li>
            <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
              <div class="flex items-center justify-between">
                <div class="grow flex items-center truncate">
                  <img class="w-7 h-7 rounded-full mr-2" src="/assets/img/placeholder.jpg" width="28" height="28" alt="Channel 02" />
          ...
          <li>
            <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
              <div class="flex items-center justify-between">
                <div class="grow flex items-center truncate">
                  <img class="w-7 h-7 rounded-full mr-2" src="/assets/img/placeholder.jpg" width="28" height="28" alt="Channel 03" />
