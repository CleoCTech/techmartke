<template>
    <TransitionRoot appear :show="isVisible" as="template">
      <div role="alert" class="fixed inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end z-50">
        <TransitionChild
          as="template"
            ...
            <div class="p-4">
              <div class="flex items-start">
                <div class="flex-shrink-0">
                  <svg v-if="type === 'warning'" class="h-6 w-6 text-amber-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <svg v-else-if="type === 'success'" class="h-6 w-6 text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
